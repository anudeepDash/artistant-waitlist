...
export async function sendWelcomeEmail({ email, name, username }: WelcomeEmailParams): Promise<{ success: boolean; message: string }> {
  try {
    ...
    const bodyText = `It's official. You've secured your username <strong>@${username}</strong> on ArtisTant! You are now part of an exclusive group of artists, clients, and industry pioneers getting first-dibs on the future of live entertainment booking and coordination.<br><br>Here's what happens next:<br><br>1. <strong>Share the Hype</strong>: Show the community you're locked in. Tag us on Instagram <strong>@artistant.in</strong> or LinkedIn and let your network know your official handle.<br><br>2. <strong>Your Bookability Score™</strong>: We are preparing your early dashboard. Soon you'll be able to build your profile, calculate your custom bookability rating, and set up secure escrow payments.<br><br>3. <strong>Early Access Keys</strong>: Watch your inbox for your unique access credentials to the command center.<br><br>We're building the ultimate creative link-up. Stay tuned, because the stage is being set.`;
