          ...
          <MagneticButton 
            ...
            style={{
              background: availStatus === 'available' 
                ? 'linear-gradient(135deg, #F25A2B 0%, #7C5CFF 100%)'
                : 'rgba(255, 255, 255, 0.05)',
              color: availStatus === 'available' ? '#FFFFFF' : 'rgba(255, 255, 255, 0.3)',
              fontWeight: '700',
              border: 'none',
              marginTop: '4px',
              padding: '16px 28px',
              borderRadius: '24px',
              cursor: availStatus === 'available' ? 'pointer' : 'not-allowed',
              opacity: availStatus === 'available' ? 1 : 0.6
            }}
          >
            {availStatus === 'checking' ? 'Checking...' : 'Reserve Username'}
          </MagneticButton>
        </motion.form>
          )}
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center', maxWidth: '500px', width: '100%', padding: '0 20px' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '15px', fontWeight: '700', color: '#FFFFFF' }}>Join as Host</span>
              </div>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '15px', fontWeight: '700', color: '#FFFFFF' }}>Join as Fan</span>
              </div>
              <p style={{ fontSize: '12px', color: 'var(--ink-2)', lineHeight: '1.4', margin: 0 }}>
