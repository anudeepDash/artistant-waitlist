                    ...
                    {view === 'main' && (
                      <>
                        ...
                        <button
                          type="button"
                          disabled
                          className="relative flex items-center justify-center w-full py-3.5 px-4 mb-3 rounded-2xl bg-white border border-white/10 text-black font-semibold text-sm
